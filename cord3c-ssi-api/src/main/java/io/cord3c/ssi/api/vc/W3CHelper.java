...
public class W3CHelper {
	...
	public static final String DEFAULT_VC_CONTEXT_2 = "https://www.w3.org/2018/credentials/examples/v1"; // FIXME

	public static final String DEFAULT_VERIFIABLE_CREDENTIAL = "VerifiableCredential";
